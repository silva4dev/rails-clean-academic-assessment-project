...
RSpec.describe Application::Dtos::GetHistoriesInputDto, type: :dto do
  context "with valid attributes" do
    it "returns a representation of the DTO" do
      input = Application::Dtos::GetHistoriesInputDto.new(
  ...
  context "with invalid attributes" do
    it "raises an error for missing required attributes" do
      expect {
        Application::Dtos::GetHistoriesInputDto.new
